      ...
      <MaxWidthWrapper>
        ...
        <section className="w-full max-w-4xl mx-auto flex items-center mb-8">
          <div className="mr-6">
            ...
            />
            <p className="text-sm text-gray-600 mt-2 ml-2">Created By: {organizations?.users.name}</p>
          </div>
        ...
        <div className="w-full max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <section className="col-span-2 bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4 text-center">About us</h2>
          ...
          <div className="col-span-1 flex flex-col items-center">
            ...
            <section className="w-full bg-white rounded-lg shadow-lg p-8">
              <h2 className="text-xl font-semibold text-gray-800 mb-4 text-center">Contact Information</h2>
              <div className="space-y-4">
                <div className="text-center">
                  <p className="text-gray-700 font-semibold">📍 Address</p>
                  <p className="text-gray-700">{organizations?.address || ""}</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-700 font-semibold">📞 Phone Number</p>
                  <p className="text-gray-700">{organizations?.phoneNumber || ""}</p>
                </div>
                <div className="text-center">
                  <p className="text-gray-700 font-semibold">📧 Email</p>
                  <p className="text-gray-700">{organizations?.email || ""}</p>
                </div>
              </div>
            </section>
          </div>
        ...
        <section className="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 mt-8">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800 text-center">Opportunities</h2>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <h3 className="font-bold text-gray-800">{opportunity.name}</h3>
