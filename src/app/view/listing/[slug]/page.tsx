        ...
        <div className="flex flex-col gap-12 bg-white p-12 rounded-lg shadow-lg">
          ...
          <div className="relative bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <p className="absolute bottom-4 right-4 text-sm text-gray-500">
              {listing?.createdAt
                ? `Created: ${new Date(listing.createdAt).toLocaleDateString("en-US", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                  })}`
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              {/* Description */}
              <section>
                <h2 className="text-xl font-semibold mb-4 text-left">Description</h2>
              ...
              <section className="mt-8">
                <h2 className="text-xl font-semibold mb-4 text-left">Skills Needed</h2>
            ...
            <div>
              {/* Organization */}
              <section>
                <h2 className="text-xl font-semibold mb-4 text-left">Organization</h2>
                    ...
                    <img
                      src={
                        typeof listing.organizations.thumbnail === "string"
                          ...
                          : (listing.organizations.thumbnail as { id: string })?.id || "/default-organization.png"
                      }
                      alt={listing.organizations.name || "Organization Thumbnail"}
